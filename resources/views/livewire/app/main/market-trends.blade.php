<div wire:poll.300s="fetchMarketTrends" wire:init="fetchMarketTrends" id="market-trends"
    ...
    <div class="flex justify-between items-center">
        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Market Trends</h3>
        @if (!empty($cryptos))
    ...
    @if (!empty($cryptos))
        <p class="text-xs text-gray-400 dark:text-gray-500 mt-2 text-right">{{ $lastUpdated }}</p>
    @endif
</div>
